...
public class Logic {
    public static void getResultFile(String fileNameInput, String fileNameOutput) throws Exception {
    ...
    public static double[][] getResultFrame(int[][] matrixA, int[][] matrixB) {
